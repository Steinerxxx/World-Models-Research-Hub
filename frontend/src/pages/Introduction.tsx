      ...
      <div className="space-y-8">
        <Card className="bg-card/50 backdrop-blur-sm border-border">
          ...
          <CardContent className="text-lg text-muted-foreground leading-relaxed">
            <p>
              This AI-native academic website was generated by <strong>Steinerxxx</strong>, a student from <strong>Tongji University</strong>, utilizing the power of <strong>Trae</strong> IDE.
            </p>
            <p className="mt-4">
